...
def sample(
    input_path: str = "assets/sv4d_videos/chest.gif",  # Can either be image file or folder with image files
    output_folder: Optional[str] = "outputs/sv4d2_8views",
    ...
    if azimuths_deg is None:
        ...
        azimuths_deg = np.array([0, 30, 75, 120, 165, 210, 255, 300, 330])
    assert (
    ...
    for t0 in tqdm(range(0, n_frames-T+1, T-1)):
        if t0 + T > n_frames:
            t0 = n_frames - T
